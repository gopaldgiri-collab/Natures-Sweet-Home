        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8 grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-forest text-gold flex items-center justify-center flex-shrink-0"><Clock size={18}/></div><div><div className="font-serif text-xl text-forest">Hours</div><div className="text-sm text-muted-foreground mt-1">WhatsApp concierge available 7AM – 11PM, 365 days</div></div></div>
            </div>
