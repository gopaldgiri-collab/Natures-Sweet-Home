...
const IMAGES = [
  { src: '/images/villas/dhanushkodi/Parking Space.JPG.jpeg', cat: 'Exterior'},	
  ...
  return (
    <>
      <section className="relative h-[55vh] min-h-[380px] overflow-hidden">
        <img src="/images/villas/dhanushkodi/Parking Spcae.JPG.jpeg" alt="gallery" className="absolute inset-0 w-full h-full object-cover" />
